...
\begin{body}
{\textbf{\textls[0]{Oct 16 - Now}} \par \textls[-60]{Mountain View, US}} & \textbf{Google} (Android) – \textit{Product Manager (Associate Product Manager II till Oct 17)}
...
\\
{\textbf{\textls[0]{Jul 14 - Mar 15}} \par London, UK} & \textbf{Eddy Labs} (Founder.org Class of 2015) now \href{https://angel.co/ally-smart-care}{Ally Smart Care} – \textit{Machine Learning Engineer}
...
\begin{flushleft}
	...
	\hspace{2em} $\bullet$ \underline{\smash{Programming Languages}}: Python, MATLAB, C, C++, SQL, Javascript, Assembly, HTML,Ruby, R, Perl and Java
	
	\hspace{2em} \parbox{0.95\textwidth}{$\bullet$ \underline{\smash{Technologies}}: Linux, Flask, MongoDB, RabbitMQ, Twitter Bootstrap, jQuery, Nginx, Adobe Creative Suite, AWS, embedded  development (Keil, Xilinx ISE), Google Analytics, Facebook Ads}
