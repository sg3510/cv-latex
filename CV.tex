...
\begin{body}
{\textbf{\textls[0]{Oct 16 - Now}} \par \textls[-60]{Mountain View, US}} & \textbf{Google} (Android) – \textit{Associate Product Manager II}
...
\\ {\textbf{\textls[0]{July - Sept 13}} \par \textls[0]{Cambridge, UK}} & \textbf{ARM Holdings plc} – \textit{Product Management and Marketing Intern}
