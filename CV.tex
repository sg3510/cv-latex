...
\begin{flushleft}
	...
	\hspace{2em} \parbox{0.95\textwidth}{$\bullet$ \underline{\smash{Technologies}}: Linux, Flask, MongoDB, SQL, RabbitMQ, Twitter Bootstrap, jQuery, Nginx, Adobe Creative Suite, AWS, embedded hardware development, Google Analytics, Facebook Ads}
