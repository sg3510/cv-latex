...
28 Sedlescombe Road $\bullet$ SW6 1RD $\bullet$ London \newline
+44 (0) 7856 204 421 $\bullet$ sg3510@ic.ac.uk $\bullet$ seb.grubb@gmail.com \newline
...
$\bullet$ \underline{\smash{Masters Project}}: \textls[-10]{Machine Learning -  Research into providing execution time of recommender systems by intelligently selecting unknown cells in matrices. Work featured in best final year projects.}

%Active Sample Selection for Large Scale Matrix Completion:
...
\begin{body}
{\textbf{\textls[-60]{Jul 14-Present}} \par London, UK} & \textbf{Eddy Labs} (Founder.org Class of 2015) – \textit{Machine Learning Engineer}
