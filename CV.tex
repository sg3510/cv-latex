...
$\bullet$ \underline{\smash{Masters Project}}: \textls[-10]{\textit{Active Sample Selection for Large Scale Matrix Completion} -  Research into providing execution time of recommender systems by intelligently selecting unknown cells in matrices. Work featured in best final year projects.}
...
$\bullet$ \underline{\smash{Third Year Project}}: Led a group of 8 people in planning and assembling a home energy optimisation system and took part in market research and development of machine learning algorithms
\\ 
...
\begin{body}
{\textbf{\textls[-60]{Oct 16 - Now}} \par Mountain View, USA} & \textbf{Google} – \textit{Associate Product Manager II} Android
...
{\textbf{\textls[-60]{Mai 15 - Oct 16}} \par Z{\"u}rich, CH} & \textbf{Google} – \textit{Associate Product Manager I} YouTube Analytics
...
% $\bullet$ \textls[-15]{NFW is an annual conference with a focus on financial topics. Attendees range from students to professionals}
...
\hspace{2em} $\bullet$ \underline{\smash{Programming Languages}}: MATLAB, Python, C, C++, Javascript, Assembly, Ruby, R, Perl and Java
