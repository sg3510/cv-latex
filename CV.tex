...
$\bullet$ \underline{\smash{Masters Project}}: \href{http://sg3510.github.io/al_proj/Report/thesis.pdf}{\textit{Active Sample Selection for Matrix Completion}} \hfill|\hfill  \underline{\smash{Supervisor}}: \href{http://www.iis.ee.ic.ac.uk/m.draief}{Moez Draief}

See \href{https://github.com/sg3510/al_proj}{github.com/sg3510/al\_proj \faChain} for PDF and MATLAB code.
...
$\bullet$ \href{https://github.com/sg3510/home-automation-yr3proj}{\underline{\smash{Third Year Project}}}: Led a group of 8 people in planning and assembling a home energy optimisation system. Researched and developed algorithms for presence detection (using a HMM) as well as temperature prediction (using Gaussian Process Regression).
\\ 
...
\begin{body}
{\textbf{\textls[0]{Oct 16 - Now}} \par \textls[-60]{Mountain View, US}} & \textbf{Google} (Android) – \textit{Product Manager - previously Associate Product Manager II}
...
\\	
{\textbf{\textls[0]{Mai 15 - Oct 16}} \par Z{\"u}rich, CH} & \textbf{Google} (YouTube) – \textit{Associate Product Manager I}
...
\\
{\textbf{\textls[0]{Jul 14 - Mar 15}} \par London, UK} & \textbf{Eddy Labs} (Founder.org Class of 2015) – \textit{Machine Learning Engineer}
...
%\\ {\textbf{\textls[0]{October 2013}} \par Milan, Italy} & \textbf{The Boston Consulting Group} – \textit{Unlim-IT-ed (European IT Business Strategy 3 day Workshop)}

%$\bullet$ Selected as one of 50 students for a workshop on using technology in business as a strategic advantage

%$\bullet$ \textls[-15]{Worked in a team on IT strategy project to turnaround insurance company with findings presented to CEO}
{\textbf{\textls[0]{July - Sept 13}} \par \textls[0]{Cambridge, UK}} & \textbf{ARM Holdings plc} – \textit{Product Management Intern}
...
\begin{flushleft}
	...
	\hspace{2em} \parbox{0.95\textwidth}{$\bullet$ \underline{\smash{Technologies}}: Linux, Flask, MongoDB, SQL, RabbitMQ, Twitter Bootstrap, jQuery, Nginx, Adobe Creative Suite, AWS, embedded  development (Keil, Xilinx ISE), Google Analytics, Facebook Ads}
...
\begin{body}
	{\textbf{2011-2014} \par \textls[-30]{Cambridge, UK}} & \textbf{UKESF Scholarship} \textit{(Worth £1,500/year for 3 years)}
